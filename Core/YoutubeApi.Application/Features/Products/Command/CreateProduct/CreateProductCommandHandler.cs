...
public class CreateProductCommandHandler: BaseHandler,IRequestHandler<CreateProductCommandRequest, Unit>
{
    ...
    public CreateProductCommandHandler(IMapper mapper,IUnitOfWork unitOfWork, ProductRules productRules, IHttpContextAccessor httpContextAccessor) 
    ...
    public async Task<Unit> Handle(CreateProductCommandRequest request, CancellationToken cancellationToken)
    {
        ...
        //Rules
        await _productRules.ProductTitleMustBeSame(products, request.Title);
